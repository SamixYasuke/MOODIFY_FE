...
const JoinTodaySection: React.FC = () => {
  return (
    ...
    >
      <motion.div
        className="h-full w-full max-w-[1500px] mx-6 bg-[rgba(34,60,83,1)] flex flex-col lg:flex-row justify-between items-center rounded-3xl shadow-lg hover:shadow-xl transition-shadow duration-300"
        variants={itemVariants}
      >
        <motion.div
          className="flex-1 text-start p-12 md:p-8 lg:p-10 "
          variants={itemVariants}
        >
          <motion.p
